...
import { FaLock, FaLockOpen, FaArrowLeft, FaGraduationCap, FaBook, FaCalendarAlt } from "react-icons/fa"
...
const departmentData = {
  "dept1": {
    ...
    description: "The Department of Computer Science offers a comprehensive curriculum covering programming, algorithms, artificial intelligence, and software engineering.",
    yearlySubjects: [
      {
        year: "First Year",
        subjects: [
    ...
    exitExams: [
      {
        id: "exam1",
        title: "Exam 1",
        description: "Test your knowledge of fundamental programming concepts and syntax.",
        isFree: true,
        questionCount: 50,
        duration: "60 minutes",
        difficulty: "Beginner"
      },
      {
        id: "exam2",
        title: "Exam 2",
        description: "Challenge yourself with questions on various data structures and algorithm design.",
        isFree: true,
        questionCount: 40,
        duration: "90 minutes",
      ...
      },
      {
        id: "exam3",
        title: "Exam 3",
        description: "Test your knowledge of complex database concepts, SQL, and database design.",
        isFree: false,
        price: "150 ETB",
        questionCount: 60,
      ...
      },
      {
        id: "exam4",
        title: "Exam 4",
        description: "Comprehensive exam covering software development lifecycle and best practices.",
        isFree: false,
        price: "200 ETB",
        questionCount: 75,
  ...
  "dept2": {
    ...
    description: "The Department of Electrical Engineering provides education in circuit design, power systems, electronics, and control systems.",
    yearlySubjects: [
      {
        year: "First Year",
        subjects: [
    ...
    exitExams: [
      {
        ...
        description: "Test your knowledge of fundamental circuit analysis techniques.",
        isFree: true,
        questionCount: 45,
        duration: "60 minutes",
        difficulty: "Beginner"
      },
      {
        ...
        description: "Comprehensive exam on digital logic, circuits, and systems.",
        isFree: true,
        questionCount: 50,
        duration: "75 minutes",
        difficulty: "Intermediate"
      },
      {
        ...
        description: "Advanced exam covering power generation, transmission, and distribution.",
        isFree: false,
        price: "180 ETB",
        questionCount: 65,
        duration: "120 minutes",
  ...
  "dept3": {
    ...
    description: "The Department of Mechanical Engineering focuses on design, manufacturing, thermodynamics, and materials science.",
    yearlySubjects: [
      {
        year: "First Year",
        subjects: [
    ...
    exitExams: [
      {
        ...
        description: "Test your understanding of statics and dynamics principles.",
        isFree: true,
        questionCount: 40,
        duration: "60 minutes",
        difficulty: "Beginner"
      },
      {
        ...
        description: "Comprehensive assessment of thermodynamic laws and applications.",
        isFree: true,
        questionCount: 45,
        duration: "75 minutes",
        difficulty: "Intermediate"
      },
      {
        ...
        description: "In-depth exam on machine elements, design principles, and analysis.",
        isFree: false,
        price: "20 ETB",
        questionCount: 60,
        duration: "120 minutes",
      ...
      },
      {
        ...
        description: "Comprehensive assessment of modern manufacturing processes and systems.",
        isFree: false,
        price: "250 ETB",
        questionCount: 70,
        duration: "150 minutes",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden mb-8">
          <div className="md:flex">
            ...
            <div className="p-8">
              <div className="uppercase tracking-wide text-sm text-teal-600 font-semibold">Department</div>
              <h1 className="mt-1 text-3xl font-bold text-gray-900">{department.name}</h1>
        ...
        <div className="mt-6">
          ...
          {activeTab === "overview" && (
            <div className="bg-white rounded-xl shadow-md p-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-4">About the Department</h3>
                  <p className="text-gray-600 mb-4">
                    The {department.name} department is committed to providing students with a comprehensive education
                    that combines theoretical knowledge with practical skills. Our curriculum is designed to prepare
                    students for successful careers in the field.
                  </p>
                  <p className="text-gray-600">
                    Students will learn from experienced faculty members who are experts in their respective fields.
                    The department offers state-of-the-art facilities and resources to support student learning and research.
                  </p>
                </div>
                <div>
          ...
          {activeTab === "exitExams" && (
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Exit Exams</h2>
                ...
                {department.exitExams.map((exam) => (
                  ...
                  >
                    ...
                    <div className={`absolute top-4 right-4 p-2 rounded-full ${
                      ...
                      {exam.isFree ? <FaLockOpen size={18} /> : <FaLock size={18} />}
                    </div>
                    ...
                    <div className="p-6">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-6">
                        ...
                        <div className="bg-gray-100 p-3 rounded-lg">
                          ...
                          <span className={`font-semibold ${exam.isFree ? 'text-green-600' : 'text-amber-600'}`}>
                      ...
                      {exam.isFree ? (
                        ...
                        <div className="space-y-3">
                          <button
                            className="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-amber-600 hover:bg-amber-700"
                          >
                            Purchase ({exam.price})
                          </button>
